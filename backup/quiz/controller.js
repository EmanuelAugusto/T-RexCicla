class controller {
  ...
  divCenterController(){ // responsavel por colocar a mensagem de "verificação de respostas"
      ...
      quest.innerHTML = `<div class="center 1"><img class="responsive-img" id="loadDino" src="img/dino.gif"><h3>Carregando...</h3></div>`; // div do dinossauro "mensagem de verificação de repostas"
