...
<body>
  ...
  <?php
        if ($_GET['email'] == 'emanuel02augusto@gmail.com' ){
         $nome = "Emanuel Augusto";
         $sobre_mim = "Tecnologia é meu lema mas sempre pensando no desenvolvimento sustentável.";
       }

       if ($_GET['email'] == 'leandro.spigolon@a.ficr.edu.br'){
         $nome = "Leandro spigolon";
         $sobre_mim = "Adoro uma corrida nos finais de semana, mas sempre penso em ecologia.";
       }
       if ($_GET['email'] == 'francisco.marinho@a.ficr.edu.br'){
         $nome = "Francisco Marinho";
         $sobre_mim = "Adoro uma academia tarde da noite, arroz com frango, sempre visando a sustabilidade";
       }
       if ($_GET['email'] == 'paulo.esilva@a.ficr.edu.br'){
         $nome = "Paulo Emanuel";
         $sobre_mim = "Conteúdo e futuro indefinido";
       }


       if($_GET['email'] == 'emanuel02augusto@gmail.com'  && $_GET['senha'] == "0101bravo" || 'leandro.spigolon@a.ficr.edu.br' && $_GET['senha'] == "1234" || $_GET['email'] == 'francisco.marinho@a.ficr.edu.br' && $_GET['senha'] == "1234" ||
        $_GET['email'] == 'paulo.esilva@a.ficr.edu.br' && $_GET['senha'] == "1234"){
  ...
  ?>
<h2>texto html dentro do else</h2>
  <?php
      }
  ?>
      <div class="col s12 m6">
